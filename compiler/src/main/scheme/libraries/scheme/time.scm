(define-library (scheme time)
  ...
  (begin
    (define-r7rs current-second (native-function "lliby_current_second" () -> <native-double>))
    (define-r7rs current-jiffy (native-function "lliby_current_jiffy" () -> <native-int64>))
