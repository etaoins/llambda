...
(export number? complex? real? rational? exact? integer? exact-integer? inexact? zero? even? odd? exact inexact + - / *
        ...
        truncate-remainder floor/ floor-quotient floor-remainder quotient remainder modulo max min)
...
(export char? digit-value char->integer integer->char char=? char<? char>? char<=? char>=?)
