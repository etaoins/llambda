...
class IrBlockBuilder()(implicit nameSource : LocalNameSource) extends IrInstrBuilder(nameSource) with Irable with TerminatorInstrs with MemoryInstrs with OtherInstrs {
