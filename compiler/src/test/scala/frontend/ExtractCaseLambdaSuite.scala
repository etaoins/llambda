  ...
  test("untyped (case-lambda) with fixed args") {
    ...
    inside(exprFor(
      ...
      case caseExpr @ et.CaseLambda(List(firstLambda, secondLambda)) =>
        ...
        inside(firstLambda) {
          case et.Lambda(`firstProcTypePoly`, Nil, Nil, None, et.Literal(ast.Boolean(true)), _) =>
        }

        inside(secondLambda) {
          case et.Lambda(`secondProcTypePoly`, List(_), Nil, None, et.Literal(ast.Boolean(false)), _) =>
        }
    }
  }
  ...
  test("untyped (case-lambda) with rest argument") {
    ...
    inside(exprFor(
      ...
      case caseExpr @ et.CaseLambda(List(firstLambda, secondLambda)) =>
        ...
        inside(firstLambda) {
          case et.Lambda(`firstProcTypePoly`, List(_), Nil, None, et.Literal(ast.Boolean(true)), _) =>
        }

        inside(secondLambda) {
          case et.Lambda(`secondProcTypePoly`, List(_), Nil, Some(_), et.Literal(ast.Boolean(false)), _) =>
        }
    }
  }
  ...
  test("untyped (case-lambda) with rest argument clause with no fixed args") {
    ...
    inside(exprFor(
      ...
      case caseExpr @ et.CaseLambda(List(firstLambda, secondLambda)) =>
        ...
        inside(secondLambda) {
          case et.Lambda(`secondProcTypePoly`, Nil, Nil, Some(_), et.Literal(ast.Boolean(false)), _) =>
        }
    }
  }
