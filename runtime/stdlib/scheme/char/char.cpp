...
bool llchar_char_ci_equal(UnicodeChar value1, UnicodeChar value2, RestValues<CharCell> *argHead)
{
...
bool llchar_char_ci_lt(UnicodeChar value1, UnicodeChar value2, RestValues<CharCell> *argHead)
{
	return charCompare(value1, value2, argHead,
			[] (UnicodeChar value1, UnicodeChar value2) { return value1.compare(value2, ucd::toCaseFolded) < 0; });
}

bool llchar_char_ci_gt(UnicodeChar value1, UnicodeChar value2, RestValues<CharCell> *argHead)
{
	return charCompare(value1, value2, argHead,
			[] (UnicodeChar value1, UnicodeChar value2) { return value1.compare(value2, ucd::toCaseFolded) > 0; });
}

bool llchar_char_ci_lte(UnicodeChar value1, UnicodeChar value2, RestValues<CharCell> *argHead)
{
	return charCompare(value1, value2, argHead,
			[] (UnicodeChar value1, UnicodeChar value2) { return value1.compare(value2, ucd::toCaseFolded) <= 0; });
}

bool llchar_char_ci_gte(UnicodeChar value1, UnicodeChar value2, RestValues<CharCell> *argHead)
{
	return charCompare(value1, value2, argHead,
			[] (UnicodeChar value1, UnicodeChar value2) { return value1.compare(value2, ucd::toCaseFolded) >= 0; });
}
