...
typedef StrongRef<DatumCell> DatumRef;
typedef StrongRefRange<DatumCell> DatumRefRange;
...
typedef StrongRef<NumericCell> NumericRef;
typedef StrongRefRange<NumericCell> NumericRefRange;
typedef StrongRef<ExactIntegerCell> ExactIntegerRef;
typedef StrongRefRange<ExactIntegerCell> ExactIntegerRefRange;
typedef StrongRef<InexactRationalCell> InexactRationalRef;
typedef StrongRefRange<InexactRationalCell> InexactRationalRefRange;
typedef StrongRef<CharacterCell> CharacterRef;
typedef StrongRefRange<CharacterCell> CharacterRefRange;
