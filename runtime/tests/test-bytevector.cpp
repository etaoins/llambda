...
void testFromAppended(World &world)
{
	...
	BytevectorCell *vector1 = BytevectorCell::fromData(world, vector1Data, sizeof(vector1Data));

	uint8_t vector2Data[1] = { 0 };
	BytevectorCell *vector2 = BytevectorCell::fromData(world, vector2Data, sizeof(vector2Data));

	uint8_t vector3Data[3] = { 200, 201, 202 };
	BytevectorCell *vector3 = BytevectorCell::fromData(world, vector3Data, sizeof(vector3Data));
...
void testCopy(World &world)
{
	...
	BytevectorCell *testVector = BytevectorCell::fromData(world, vectorData, sizeof(vectorData));
...
void testReplace(World &world)
{
	...
	BytevectorCell *fromVector = BytevectorCell::fromData(world, fromData, 5);
...
void testUtf8ToString(World &world)
{
	...
	BytevectorCell *sourceVector = BytevectorCell::fromData(world, stringData, 10);
...

	{
		...
		BytevectorCell *invalidVector = BytevectorCell::fromData(world, invalidData, strlen(invalidString));
